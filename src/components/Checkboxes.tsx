...
// let mealFilters = [{title: "Breakfast", value: "&breakfast"}, "Brunch", "Lunch/dinner", "Appetizer", "Cocktails", "Dessert"];
// let cuisineFilters=["Mediterranean", "Japanese", "Mexican", "Italian", "French", "Chinese", "Indian", "American"];
// let dietFilters=["Low-Carb", "Vegetarian","Vegan", "Dairy Free","Gluten Free","Wheat Free",
...
<div className="outerContainer" style={{ display: showFilters? "block" : "none"}}>
       ...
       <br/>
          <input type="checkbox" name="glutenFree" id="glutenDree" value="+&gltuten+free"
       ...
       {/* END OF TEXT BOXES */}
          ...
          {/* <input type="checkbox" name="breakfast" id="breakfast" value="+&breakfast" onClick={handleClick}
            onChange={ !checked ? ()=>setSearchTerm(textSearchTerm + "&breakfast") : ()=>setSearchTerm(textSearchTerm)}/>
       ...
       <br/>
          <input type="checkbox" name="brunch" id="brunch" value="+&brunch" onClick={handleClick}
            onChange={ !checked ? ()=>setSearchTerm(textSearchTerm + "&brunch") : ()=>setSearchTerm(textSearchTerm)} />
       ...
       <br/>
          <input type="checkbox" name="lunch-dinner" id="lunch-dinner" value="+&lunch/dinner" onClick={handleClick}
            onChange={ !checked ? ()=>setSearchTerm(textSearchTerm + "&lunch/dinner") : ()=>setSearchTerm(textSearchTerm)} />
